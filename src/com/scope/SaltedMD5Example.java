...
public class SaltedMD5Example {
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchProviderException {
		...
		System.out.println(regeneratedPassowrdToVerify); // Prints
															// 83ee5baeea20b6c21635e4ea67847f66
		passwordStatic(true,"password");

	}

	public static String passwordStatic(boolean bol, String pswd_txt) {

		String passwordToHash = "";
		if (bol) {
			passwordToHash = pswd_txt;
		} else
			passwordToHash = UUID.randomUUID().toString().replace("-", "");
