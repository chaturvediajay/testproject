			...
			<div class="top-head">
				<div class="header-para">
					<ul class="social-in">
						<li><a href="#"><i> </i></a></li>
						<li><a
							href="https://www.facebook.com/HomeFurnisinghRugsCarpets/?ref=br_rs"><i
								class="ic"> </i></a></li>
			...
			<div class="head-top">
				<div class="logo">
					<a href="${pageContext.request.contextPath}/"><img
						class="img-responsive" src="images/logo.png" alt=""
						style="height: 43px; margin-left: -10px; margin-bottom: -68px; margin-top: -11px;"></a>
				</div>
