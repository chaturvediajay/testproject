	...
	<h2>CONTACT US...</h2>
				...
				<div class=" col-md-3 contact-right">
				     	<h5>Chouhan Rugs</h5>
				 	 	...
				 	 	<p>Email: <a href="mailto:info@chouhanrugs.com">info@chouhanrugs.com</a></p>
				   		<p>Follow on: <a href="#">Facebook</a>, <a href="#">Twitter</a></p>
				   		
				   		<p>Monday-Friday</p>
				   		<p>10:00 am - 5.00 pm IST (Indian Standard Time)<br></p>
				...
				<div class=" col-md-9 contact-left">
					    ...
					    <form id="queryForm" method="post">
							...
							<div>
						    	<span>Name</span>
						    	<input name="name" id="name" type="text" placeholder="Enter Name Here.."class="form-control">
						    </div>
							<div >
								<span>Email</span>
								<input name="username"  id="username" type="text" placeholder="Enter Email Address Here.." class="form-control">
							</div>
							<div>
						    	<span>Subject</span>
						    	<textarea name="userMsg" id="userMsg" type="text" placeholder="Type Your Message" class="form-control"> </textarea>
						    </div>	
			                <!-- /.col -->
				                <div><br>
...
<!-- End JS -->
	...
	$(function() {
		...
		var ruleCall ={ name : "required",
				name : { required : true, minlength : 3, noSpace : false }, 
				username : { required : true, minlength : 5, lettersonly : true, noSpace : true }, 
				userMsg : { required : true, minlength : 10,noSpace : false }  };
		var msg ={
