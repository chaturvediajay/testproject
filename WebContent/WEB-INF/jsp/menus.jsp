<div class="top-nav" style=" padding-left: 17px;">
			  ...
			  <ul class="megamenu skyblue"><li class="showhide" style="overflow: hidden;"><span class="title">MENU</span><span class="icon1"></span><span class="icon2"></span></li>
						...
						<div class="row">
							<div class="col1">
								<div class="h_nav">
									<ul>
										<c:if test="${num2 == 1}">
										<li><a href="${pageContext.request.contextPath}/products">${m2.submenu}</a></li>
	                           			</c:if>
									</ul>	
								</div>							
							</div>
